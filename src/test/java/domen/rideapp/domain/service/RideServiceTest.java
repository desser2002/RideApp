...
class RideServiceTest {
    ...
    void shouldAssignRidesWhenRidesAmountIsMoreThenDrivers() {
        ...
        GeoPoint to = new GeoPoint(51.1079, 17.0385);
        Localization localization = new Localization(from, to);
        Ride ride1 = spy(new Ride("Customer1", localization, RideStatus.PENDING, 12.01));
        Ride ride2 = spy(new Ride("Customer2", localization, RideStatus.PENDING, 12.02));
        Ride ride3 = spy(new Ride("Customer3", localization, RideStatus.PENDING, 12.03));
